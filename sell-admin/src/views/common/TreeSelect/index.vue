...
export default {
  ...
  methods: {
    getTreeNodeById(id) {
      const treeNodeByInt = getTreeNode(this.treeList, id, 'id', 'children');
      const treeNodeByStr = getTreeNode(this.treeList, Number(id), 'id', 'children');
      return treeNodeByInt || treeNodeByStr || {};
    },
    initTree() {
      return this.$refs.tree.initTree();
    },
    initExpanded() {
      return this.$refs.tree.initExpanded();
    },
    getCurrentNode() {
